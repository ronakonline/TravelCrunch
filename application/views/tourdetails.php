...
<?php $this->load->view('header'); ?>
		<!--************************************
				Inner Banner Start
		*************************************-->
		<div class="tg-parallax tg-innerbanner" data-appear-top-offset="600" data-parallax="scroll" data-image-src="<?php echo base_url();?>assets/images/parallax/bgparallax-06.jpg">
							...
							<div class="tg-tourbookingdetail">
								<div class="tg-bookinginfo">
									...
									<div class="tg-pricearea">
										<span>From</span>
										<del>$2,800</del>
										<h4>$2,500<sub>/ per person</sub></h4>
									</div>
									...
									<div class="tg-refundshare">
										<div class="tg-refund">
											<figure><img src="<?php echo base_url();?>assets/images/img-03.jpg" alt="image description"></figure>
