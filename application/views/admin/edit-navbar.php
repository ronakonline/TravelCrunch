							...
							<div class="card m-b-30">
								<div class="card-body">
									...
									<div class="form-group">
										...
										<textarea class="form-control" name="first" ><?php echo $navbar[0]->first; ?></textarea>
									</div>
									<div class="form-group">
										<label for="example-text-input" class="col col-form-label">Second</label>
										<input class="form-control" type="tel" name="second" id="second" value="<?php echo $navbar[0]->second; ?>" required>
									</div>
									<div class="form-group">
										<label for="example-text-input" class="col col-form-label">Third</label>
										<input class="form-control" type="text" name="third" id="third" value="<?php echo $navbar[0]->third; ?>" required>
									</div>
									<div class="form-group">
										<label for="example-text-input" class="col col-form-label">Fourth</label>
										<input class="form-control" type="text" name="four" id="four" value="<?php echo $navbar[0]->four; ?>" required>
									</div>

									<div class="form-group">
										<label for="example-text-input" class="col col-form-label">Fifth</label>
										<input class="form-control" type="text" name="five" id="five" value="<?php echo $navbar[0]->five; ?>" required>
									</div>
